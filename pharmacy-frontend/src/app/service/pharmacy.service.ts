...
import { PHARMACY_PATH, PHARMACY_SUB_PATH, SUBSCRIBE_PATH, UNSUBSCRIBE_PATH, AVAILABLE_PHARMACIES, PHARMACY_FROM_PHARMACY_NAME, PHARMACY_PROFIT } from '../util/paths';
...
export class PharmacyService {
  ...
  getProfit(dto:any): any{
    return this.httpClient.post(PHARMACY_PROFIT, dto);
  }

  pharmacy_from_name(name: string): any{
    return this.httpClient.get(PHARMACY_FROM_PHARMACY_NAME + "/" + name);
  }
