...
import { GET_MEDICINEPHARMACYBYADMIN_PATH, GET_MEDICINEPHARMACY_PATH, MEDICINEPHARMACY_PATH, MEDICINEPH_BY_MEDICINE_PATH, MEDICINES_PHARMACIST_PATH, MEDICINES_PHARMACY_PATH } from '../util/paths';
