...
insert into app_user (name, surname, email, password, address, city, country, phone, role, active) values ('Vimona', 'Prokic', 'vikica@gmail.com', 'vikica', 'Fruskogorsa 15', 'Novi Sad', 'Srbija', '067/114885', 5, true);
-- PharmacyAdmin
