...
insert into examination(patient_came, price, dermatologist_id, loyalty_group_id, patient_id, pharmacy_id, prescription_id, schedule_id)VALUES (true , 15, 1, 1, 1, 1, 1, 1);
